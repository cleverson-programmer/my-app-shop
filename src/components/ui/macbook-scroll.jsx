...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="min-h-[100vh] sm:min-h-[80dvh] flex flex-col items-center py-0 md:py-36 justify-start flex-shrink-0 [perspective:900px] transform md:scale-100 scale-[0.60] sm:scale-100 sm:py-0">
      <motion.h2
        style={{
          translateY: textTransform,
          opacity: textOpacity,
        }}
        className="dark:text-white text-white text-4xl font-bold mb-20 text-center">
        {title || (
          <span>
